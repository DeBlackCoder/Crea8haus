  ...
  return (
    <div className="about-body">
      ...
      >
        ...
        At Crea8haus, we craft innovative digital experiences designed to help
        businesses grow. We combine strategy, creativity, and modern technology
        to build brands that stand out. Our approach is collaborative — we
        listen, research, and create with intention. Every project is tailored,
        ensuring results that align with your goals and audience. We don’t just
        design — we elevate your digital presence and bring your vision to life.
      </motion.div>
        ...
        >
          ...
          <div className="testimonial-carousel">
            <div className="testimonial-track">
              ...
              <div className="testimonial-card">
                “They transformed our online presence beyond expectation.”
              </div>
              <div className="testimonial-card">
                “Clear communication from start to finish. Smooth workflow.”
              </div>
              <div className="testimonial-card">
                “Delivered earlier than scheduled — and quality was top-notch.”
              </div>
              <div className="testimonial-card">
                “You can tell they truly care about the success of the project.”
              </div>
              <div className="testimonial-card">
                “Very flexible, adaptive and easy to work with. 10/10.”
              </div>
              <div className="testimonial-card">
                “Exceeded our requirements with a clean and modern design.”
              </div>
              <div className="testimonial-card">
                “Support after delivery was impressive — no one does that
                anymore.”
              </div>
